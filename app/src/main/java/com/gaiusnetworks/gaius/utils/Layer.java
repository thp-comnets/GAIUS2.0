...
public class Layer {
    ...
    private boolean videoHasThumbnail;
    ...
    public void setIsNewContent(boolean newContent) {
    ...
    public boolean videoHasThumbnail() {
        return videoHasThumbnail;
    }

    public void videoHasThumbnail(boolean videoHasThumbnail) {
        this.videoHasThumbnail = videoHasThumbnail;
    }
