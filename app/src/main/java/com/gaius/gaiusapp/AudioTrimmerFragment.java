...
import com.gaius.gaiusapp.customAudioViews.MarkerView;
...
public class AudioTrimmerFragment extends Fragment implements View.OnClickListener, MarkerView.MarkerListener, WaveformView.WaveformListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtAudioCancel = (TextView) rootView.findViewById(R.id.txtAudioCancel);
        txtAudioUpload = (TextView) rootView.findViewById(R.id.txtAudioUpload);
        txtStartPosition = (TextView) rootView.findViewById(R.id.txtStartPosition);
        txtEndPosition = (TextView) rootView.findViewById(R.id.txtEndPosition);
        llAudioCapture = (LinearLayout) rootView.findViewById(R.id.llAudioCapture);
        txtAudioRecord = (TextView) rootView.findViewById(R.id.txtAudioRecord);
        txtAudioRecordTime = (TextView) rootView.findViewById(R.id.txtAudioRecordTime);
        rlAudioEdit = (RelativeLayout) rootView.findViewById(R.id.rlAudioEdit);
        markerStart = (MarkerView) rootView.findViewById(R.id.markerStart);
        markerEnd = (MarkerView) rootView.findViewById(R.id.markerEnd);
        audioWaveform = (WaveformView) rootView.findViewById(R.id.audioWaveform);
        txtAudioRecordTimeUpdate = (TextView) rootView.findViewById(R.id.txtAudioRecordTimeUpdate);
        txtAudioReset = (TextView) rootView.findViewById(R.id.txtAudioReset);
        txtAudioDone = (TextView) rootView.findViewById(R.id.txtAudioDone);
        txtAudioPlay = (TextView) rootView.findViewById(R.id.txtAudioPlay);
        txtAudioRecordUpdate = (TextView) rootView.findViewById(R.id.txtAudioRecordUpdate);
        txtAudioCrop = (TextView) rootView.findViewById(R.id.txtAudioCrop);
...
//        mEndPos = audioWaveform.secondsToPixels(15.0);
    ...
    public void onClick(View view) {
        if (view == txtAudioRecord) {
            ...
            if (difference <= 0) {
                Toast.makeText(getActivity(), "Trim seconds should be greater than 0 seconds", Toast.LENGTH_SHORT).show();
            } else if (difference > 60) {
                Toast.makeText(getActivity(), "Trim seconds should be less than 1 minute", Toast.LENGTH_SHORT).show();
            } else {
                if (mIsPlaying) {
                    handlePause();
                }
